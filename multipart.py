...
import queue # 2.5 module required Queue
import random, time, sys, threading, posixpath, traceback, os
import ftplib

#this code run at the backup server
...
def main(host, user, passwd, src,
	...
	#set copy file path
    dst = os.path.join('C:/batch/', srcfile)
